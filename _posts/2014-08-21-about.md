...
## Participate
<del>If interested please **apply** with us.</del> **Applications are now closed.** Applicants will be invited according to the following priority: 
...
<a class="btn btn-success">Applications Closed</a> <!--<a class="btn btn-success lightbox-42325467071149">Apply</a>--> <a href="https://github.com/woodshop/woodshop.github.io/wiki" class="btn btn-info">Wiki</a> <a href="mailto:sarroff@cs.dartmouth.edu?subject=AV Synthesis Workshop" class="btn btn-primary">Contact Us</a>
...
## Graduate Program in Digital Musics
